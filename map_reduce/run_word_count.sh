...
hadoop jar $HADOOP_HOME/share/hadoop/tools/lib/hadoop-streaming-2.8.1.jar -input /cs5540/input -output /cs5540/output -mapper ./word_count_mapper.py -reducer ./word_count_reducer.py -numReduceTasks 1
